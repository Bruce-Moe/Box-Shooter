...
public class GameManager : MonoBehaviour {
	...
	private GameObject[] positiveTargets;

	private Dictionary<GameObject, int> scoreAmounts;
	...
	void Start () {
		...
		gameTime = startTime;
		scoreAmounts = new Dictionary<GameObject, int>();
	...
	void BeatLevel() {
		...
		mainTimerDisplay.GetComponent<Text>().color = Color.green;
	...
	public void multiplierTargetHit() 
	{
		endTime = gameTime - multiplierTime;
		if(gameTime >= endTime) {
			positiveTargets = GameObject.FindGameObjectsWithTag("Positive");
			foreach(GameObject pos in positiveTargets) {
				if(!scoreAmounts.ContainsKey(pos)) {
